...
func (_mock *MockLogger) Error(msg string, fields ...interface{}) {
	var _ca []interface{}
	_ca = append(_ca, msg)
	_ca = append(_ca, fields...)
	_mock.Called(_ca...)
...
func (_c *MockLogger_Error_Call) RunAndReturn(run func(msg string, fields ...interface{})) *MockLogger_Error_Call {
	_c.Run(run)
	return _c
}
