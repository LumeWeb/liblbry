...
func (_mock *MockNotifier) Notify(id string, data string) error {
...
//   - id string
//   - data string
func (_e *MockNotifier_Expecter) Notify(id interface{}, data interface{}) *MockNotifier_Notify_Call {
	return &MockNotifier_Notify_Call{Call: _e.mock.On("Notify", id, data)}
}

func (_c *MockNotifier_Notify_Call) Run(run func(id string, data string)) *MockNotifier_Notify_Call {
...
func (_c *MockNotifier_Notify_Call) RunAndReturn(run func(id string, data string) error) *MockNotifier_Notify_Call {
	_c.Call.Return(run)
	return _c
}
